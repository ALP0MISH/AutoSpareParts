...
import com.example.moviesapp.domain.use_case.FetchAllSavedMoviesUseCaseImpl
import com.example.moviesapp.domain.use_case.FetchMovieByIdUseCase
import com.example.moviesapp.domain.use_case.FetchMovieByIdUseCaseImpl
import com.example.moviesapp.domain.use_case.FetchMoviePeoplesUseCase
import com.example.moviesapp.domain.use_case.FetchMoviePeoplesUseCaseImpl
import com.example.moviesapp.domain.use_case.FetchMovieReviewsUseCase
import com.example.moviesapp.domain.use_case.FetchMovieReviewsUseCaseImpl
import com.example.moviesapp.domain.use_case.FetchMoviesInteractor
import com.example.moviesapp.domain.use_case.FetchMoviesInteractorImpl
import com.example.moviesapp.domain.use_case.IsMovieSavedUseCaseIMpl
import com.example.moviesapp.domain.use_case.IsMovieSavedUseCase
import com.example.moviesapp.domain.use_case.MovieOperatorUseCase
import com.example.moviesapp.domain.use_case.MovieOperatorUseCaseImpl
import com.example.moviesapp.domain.use_case.SearchMoviesByQueryUseCase
import com.example.moviesapp.domain.use_case.SearchMoviesByQueryUseCaseImpl
import dagger.Binds
